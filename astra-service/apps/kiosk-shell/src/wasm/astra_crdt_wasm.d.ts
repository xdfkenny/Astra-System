 ...
 * `astra-service/sync-daemon/crates/astra-crdt-wasm` (see the sync daemon
 * README). These declarations let the kiosk shell typecheck and build before
 * the WASM artifact is generated.
 */
