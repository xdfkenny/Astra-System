 ...
 *
 * In landscape mode renders children with a full-screen warning overlay
 * on top so the app tree stays mounted (cart state, navigation preserved).
 *
 * In portrait mode renders children normally.
 *
 * The overlay enters/exits with a Framer Motion fade (250ms, ease-out-expo)
 * to avoid jarring transitions during rotation or resize.
 */
