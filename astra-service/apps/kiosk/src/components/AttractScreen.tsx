/*Landing page with animated organic blobs and tap-to-start interaction.
Full-screen Linen background with slow morphing shapes.
Clips around touch point when tapped.
*/
