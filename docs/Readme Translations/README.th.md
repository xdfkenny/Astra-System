...
> แพลตฟอร์มชำระเงินด้วยตนเองอัตโนมัติระดับการผลิตที่ออกแบบมาเพื่อทำงานแบบออฟไลน์เป็นอันดับแรกสำหรับสภาพแวดล้อมค้าปลีก 24/7

คำแปลนี้กำลังอยู่ในระหว่างดำเนินการ โปรดดู README ภาษาอังกฤษสำหรับเอกสารฉบับสมบูรณ์

---

## ไทย

**Astra-System** เป็นโมโนเรโพแบบหลายภาษาที่ขับเคลื่อนตู้ชำระเงินด้วยตนเองทั้งแบบมีและไม่มีพนักงานดูแล
