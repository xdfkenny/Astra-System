...
> Nền tảng thanh toán tự động được thiết kế cho môi trường bán lẻ 24/7, ưu tiên hoạt động ngoại tuyến ở cấp độ sản xuất.

Bản dịch này đang được thực hiện. Vui lòng tham khảo README tiếng Anh để có tài liệu đầy đủ.

---

## Tiếng Việt

**Astra-System** là một monorepo đa ngôn ngữ hỗ trợ các ki-ốt tự thanh toán có giám sát và không giám sát.
