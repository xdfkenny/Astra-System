...
> 7/24 perakende ortamları için mühendislikle üretilmiş, çevrimdışı öncelikli otomatik self-checkout platformu.

Bu çeviri devam etmektedir. Tam dokümantasyon için lütfen İngilizce README'ye bakın.

---

## Türkçe

**Astra-System** gözetimli ve gözetimsiz self-checkout kiosklarını çalıştıran çok dilli bir monorepodur.
