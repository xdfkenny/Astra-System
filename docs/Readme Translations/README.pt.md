...
> Plataforma de autoatendimento automatizada de nível de produção, projetada para operar offline primeiro em ambientes de varejo 24/7.

Esta tradução está em andamento. Consulte o README em inglês para obter a documentação completa.

---

## Português

**Astra-System** é um monorepo multilíngue que alimenta quiosques de autoatendimento com e sem supervisão.
