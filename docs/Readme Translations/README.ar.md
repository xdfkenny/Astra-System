...
> منصة إنتاجية للدفع الذاتي الآلي تعمل في وضع عدم الاتصال أولاً، ومصممة لبيئات البيع بالتجزئة على مدار الساعة.

هذه الترجمة قيد العمل. يُرجى مراجعة ملف README الإنجليزي للحصول على الوثائق الكاملة.

---

## العربية

**Astra-System** هو مستودع واحد متعدد اللغات يدعم أكشاك الدفع الذاتي المراقبة وغير المراقبة.
